...
def wrap():
	...
	parser.add_argument('-p', metavar='paired-end file', help='file with paired-end reads')
	parser.add_argument('-s', metavar='single-end file', help='file with single-end reads')
